...
void Config::read(FILE *stream) throw()
{
...
void Config::readString(const char *str) throw()
{
...
// ---------------------------------------------------------------------------
  ...
  void Config::readFile(const char *filename) throw()
{
...
// ---------------------------------------------------------------------------
  ...
  void Config::writeFile(const char *filename) throw()
{
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator bool() const throw()
{
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator int() const throw()
{
  assertType(TypeInt);
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator unsigned int() const throw()
{
  assertType(TypeInt);
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator long() const throw()
{
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator unsigned long() const throw()
{
  if(sizeof(long) == sizeof(long long))
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator long long() const throw()
{
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator unsigned long long() const throw()
{
  assertType(TypeInt64);
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator double() const throw()
{
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator float() const throw()
{
  assertType(TypeFloat);
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator const char *() const throw()
{
...
// ---------------------------------------------------------------------------
  ...
  Setting::operator std::string() const throw()
{
  assertType(TypeString);
...
// ---------------------------------------------------------------------------
  ...
  Setting & Setting::operator=(bool value) throw()
{
  assertType(TypeBoolean);
...
// ---------------------------------------------------------------------------
  ...
  Setting & Setting::operator=(int value) throw()
{
  assertType(TypeInt);
...
Setting & Setting::operator=(long value) throw()
{
  if(sizeof(long) == sizeof(long long))
...
// ---------------------------------------------------------------------------
  ...
  Setting & Setting::operator=(const double &value) throw()
{
  assertType(TypeFloat);
...
// ---------------------------------------------------------------------------
  ...
  Setting & Setting::operator=(float value) throw()
{
  assertType(TypeFloat);
...
// ---------------------------------------------------------------------------
  ...
  Setting & Setting::operator=(const char *value) throw()
{
  assertType(TypeString);
...
const Setting & Setting::getParent() const throw()
{
...
Setting & Setting::getParent() throw()
{
  config_setting_t *setting = config_setting_parent(_setting);
...
// ---------------------------------------------------------------------------
 ...
 Setting & Setting::add(Setting::Type type) throw()
{
