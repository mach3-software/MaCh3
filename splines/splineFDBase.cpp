...
//****************************************
std::vector<TAxis *> splineFDBase::FindSplineBinning(const std::string& FileName, const std::string& SampleName)
//****************************************
{
...
std::string splineFDBase::getDimLabel(const int iSample, const unsigned int Axis) const
//****************************************
{
...
//****************************************
std::vector< std::vector<int> > splineFDBase::GetEventSplines(const std::string& SampleName, int iOscChan, int EventMode, double Var1Val, double Var2Val, double Var3Val)
//****************************************
{
...
std::vector< std::vector<int> > splineFDBase::StripDuplicatedModes(const std::vector< std::vector<int> >& InputVector) {
