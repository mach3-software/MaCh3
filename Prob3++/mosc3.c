...
double Ain[3][3][2];
//static 
double dm21,dm32,s12,s23,s31,cd;
 ...
 */
void init_mixing_matrix(dm21f,dm32f,s12f,s23f,s31f,cdf)
     double dm21f,dm32f,s12f,s23f,s31f,cdf;
{
...
void get_oscillation_parameters(dm21f,dm32f,s12f,s23f,s31f,cdf)
     double dm21f,dm32f,s12f,s23f,s31f,cdf;
{
  dm21f = dm21;
  dm32f = dm32;
