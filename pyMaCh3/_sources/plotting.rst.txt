...
The plotting module can be used to make beautiful plots. See the `plotting wiki page <https://mach3-software.github.io/MaCh3/group__MaCh3Plotting.html>`_ for information on how to configure the plotting library to work with your MaCh3 output files and other non-MaCh3 based fitters so you can compare results.
