...
The MaCh3 core plotting library code can be found [here]([https://github.com/mach3-software/MaCh3/develop/plotting) along with example config files and some apps for making standard plots.
