...
SampleHandlerBase_t<EventDataType>::SampleHandlerBase_t(std::string ConfigFileName, ParameterHandlerGeneric* xsec_cov,
                                     const std::shared_ptr<OscillationHandler>& OscillatorObj_) : SampleHandlerInterface() {
// ************************************************
  MACH3LOG_INFO("-------------------------------------------------------------------");
  MACH3LOG_INFO("Creating SampleHandlerBase_t object");
  ...
  if (OscillatorObj_ != nullptr) {
    MACH3LOG_WARN("You have passed an Oscillator object through the constructor of a SampleHandlerBase_t object - this will be used for all oscillation channels");
...
template<typename EventDataType>
SampleHandlerBase_t<EventDataType>::~SampleHandlerBase_t() {
  MACH3LOG_DEBUG("I'm deleting SampleHandlerBase_t");
  if(THStackLeg != nullptr) delete THStackLeg;
}

template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::ReadConfig()
{
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::LoadSingleSample(const int iSample, const YAML::Node& SampleSettings) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::Initialise() {
// ************************************************
  TStopwatch clock;
  clock.Start();
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SetupKinematicMap() {
// ************************************************
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::FillHist(const int Sample, TH1* Hist, std::vector<double> &Array) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
bool SampleHandlerBase_t<EventDataType>::IsEventSelected(const int iSample, const int iEvent) _noexcept_ {
// ************************************************
...
template<typename EventDataType>
bool SampleHandlerBase_t<EventDataType>::IsSubEventSelected(const std::vector<KinematicCut> &SubEventCuts, const int iEvent, const unsigned int iSubEvent, size_t nsubevents) {
...
// Reweight function
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::Reweight() {
//************************************************
...
// already been calculated and stored in SampleHandlerBase_t.osc_w[iEvent]. This
// function takes advantage of most of the things called in setupSKMC to reduce reweighting time.
// It also follows the ND code reweighting pretty closely. This function fills the SampleHandlerBase_t
...
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::FillArray() {
//************************************************
...
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::FillArray_MP() {
// ************************************************
  //DB Reset which cuts to apply
  Selection = StoredSelection;
...
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::ResetHistograms() {
// **************************************************
...
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::RegisterIndividualFunctionalParameter(const std::string& fpName, int fpEnum, FuncParFuncType fpFunc){
...
// **************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SetupFunctionalParameters() {
// **************************************************
...
// ***************************************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::ApplyShifts(const int iEvent) {
// ***************************************************************************
...
template<typename EventDataType>
M3::float_t SampleHandlerBase_t<EventDataType>::CalcWeightTotal(const EventInfo* _restrict_ MCEvent) const _noexcept_ {
// ***************************************************************************
...
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SetupOscParameters() {
// ***************************************************************************
...
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SetupNormParameters() {
// ***************************************************************************
  if(ParHandler == nullptr) return;
...
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::CalcNormsBins(std::vector <std::vector<NormParameter>>& norm_parameters, std::vector< std::vector< int > >& norms_bins) {
// ************************************************
  for(unsigned int iEvent = 0; iEvent < GetNEvents(); ++iEvent){
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SetupReweightArrays() {
// ************************************************
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SetBinning() {
// ************************************************
  for(int iSample = 0; iSample < GetNSamples(); iSample++)
  {
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::FindNominalBinAndEdges() {
// ************************************************
...
// ************************************************
template<typename EventDataType>
int SampleHandlerBase_t<EventDataType>::GetSampleIndex(const std::string& SampleTitle) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
const TH1* SampleHandlerBase_t<EventDataType>::GetW2Hist(const int Sample) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
const TH1* SampleHandlerBase_t<EventDataType>::GetW2Hist(const std::string& Sample) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
const TH1* SampleHandlerBase_t<EventDataType>::GetMCHist(const int Sample) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
const TH1* SampleHandlerBase_t<EventDataType>::GetMCHist(const std::string& Sample) {
// ************************************************
  const int Index = GetSampleIndex(Sample);
...
// ************************************************
template<typename EventDataType>
const TH1* SampleHandlerBase_t<EventDataType>::GetDataHist(const int Sample) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
const TH1* SampleHandlerBase_t<EventDataType>::GetDataHist(const std::string& Sample) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::AddData(const int Sample, TH1* Data) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::AddData(const int Sample, const std::vector<double>& Data_Array) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::InitialiseNuOscillatorObjects() {
// ************************************************
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SetupNuOscillatorPointers() {
// ************************************************
...
// ************************************************
template<typename EventDataType>
const M3::float_t* SampleHandlerBase_t<EventDataType>::GetNuOscillatorPointers(const int iEvent) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
std::string SampleHandlerBase_t<EventDataType>::GetName() const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
M3::float_t SampleHandlerBase_t<EventDataType>::GetEventWeight(const int iEntry) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
std::vector< std::vector<int> > SampleHandlerBase_t<EventDataType>::GetSplineBins(int Event, BinnedSplineHandler* BinnedSpline, bool& ThrowCrititcal) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SetSplinePointers() {
// ************************************************
...
// ************************************************
template<typename EventDataType>
double SampleHandlerBase_t<EventDataType>::GetSampleLikelihood(const int isample) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
double SampleHandlerBase_t<EventDataType>::GetLikelihood() const {
// ************************************************
  double negLogL = 0.;
  #ifdef MULTITHREAD
  #pragma omp parallel for reduction(+:negLogL)
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::SaveAdditionalInfo(TDirectory* Dir) {
// ************************************************
  Dir->cd();
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::InitialiseSplineObject() {
// ************************************************
...
// ************************************************
template<typename EventDataType>
std::vector<std::vector<KinematicCut>> SampleHandlerBase_t<EventDataType>::ApplyTemporarySelection(const int iSample,
...
template<typename EventDataType>
std::unique_ptr<TH1> SampleHandlerBase_t<EventDataType>::Get1DVarHist(const int iSample, const std::string& ProjectionVar_Str,
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::Fill1DSubEventHist(const int iSample, TH1D* _h1DVar, const std::string& ProjectionVar_Str,
...
// ************************************************
template<typename EventDataType>
std::unique_ptr<TH2> SampleHandlerBase_t<EventDataType>::Get2DVarHist(const int iSample,
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::Fill2DSubEventHist(const int iSample, TH2* _h2DVar,
                                         const std::string& ProjectionVar_StrX,
                                         const std::string& ProjectionVar_StrY,
                                         const std::vector< KinematicCut >& SubEventSelectionVec,
                                         int WeightStyle) {
...
// ************************************************
template<typename EventDataType>
int SampleHandlerBase_t<EventDataType>::ReturnKinematicParameterFromString(const std::string& KinematicParameterStr) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
std::string SampleHandlerBase_t<EventDataType>::ReturnStringFromKinematicParameter(const int KinematicParameter) const {
// ************************************************
...
template<typename EventDataType>
int SampleHandlerBase_t<EventDataType>::ReturnKinematicVectorFromString(const std::string& KinematicVectorStr) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
std::string SampleHandlerBase_t<EventDataType>::ReturnStringFromKinematicVector(const int KinematicVector) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
std::vector<double> SampleHandlerBase_t<EventDataType>::ReturnKinematicParameterBinning(const int Sample, const std::string& KinematicParameter) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
bool SampleHandlerBase_t<EventDataType>::IsSubEventVarString(const std::string& VarStr) const {
// ************************************************
...
// ************************************************
template<typename EventDataType>
std::vector<KinematicCut> SampleHandlerBase_t<EventDataType>::BuildModeChannelSelection(const int iSample, const int kModeToFill, const int kChannelToFill) const {
// ************************************************
  bool fChannel;
  bool fMode;
...
// ************************************************
template<typename EventDataType>
std::unique_ptr<TH1> SampleHandlerBase_t<EventDataType>::Get1DVarHistByModeAndChannel(const int iSample, const std::string& ProjectionVar_Str,
...
// ************************************************
template<typename EventDataType>
std::unique_ptr<TH2> SampleHandlerBase_t<EventDataType>::Get2DVarHistByModeAndChannel(const int iSample, const std::string& ProjectionVar_StrX,
...
// ************************************************
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::PrintIntegral(const int iSample, const TString& OutputFileName, const int WeightStyle, const TString& OutputCSVFileName) {
// ************************************************
...
// ************************************************
template<typename EventDataType>
std::vector<std::unique_ptr<TH1>> SampleHandlerBase_t<EventDataType>::ReturnHistsBySelection1D(const int iSample, const std::string& KinematicProjection,
...
// ************************************************
template<typename EventDataType>
std::vector<std::unique_ptr<TH2>> SampleHandlerBase_t<EventDataType>::ReturnHistsBySelection2D(const int iSample, const std::string& KinematicProjectionX,
...
// ************************************************
template<typename EventDataType>
std::unique_ptr<THStack> SampleHandlerBase_t<EventDataType>::ReturnStackedHistBySelection1D(const int iSample, const std::string& KinematicProjection,
...
// ************************************************
template<typename EventDataType>
const double* SampleHandlerBase_t<EventDataType>::GetPointerToOscChannel(const int iEvent) const {
// ************************************************
...
template<typename EventDataType>
void SampleHandlerBase_t<EventDataType>::PrintRates(const bool DataOnly) {
// ***************************************************************************
  if (!SampleHandler_data.size()) {
...
template<typename EventDataType>
std::string SampleHandlerBase_t<EventDataType>::GetKinVarName(const int iSample, const int Dimension) const {
// ***************************************************************************
...
// ***************************************************************************
template<typename EventDataType>
std::vector<double> SampleHandlerBase_t<EventDataType>::GetArrayForSample(const int Sample, std::vector<double> const & array) const {
// ***************************************************************************
  const int Start = Binning->GetSampleStartBin(Sample);
  const int End   = Binning->GetSampleEndBin(Sample);
...
bool SampleHandlerBase_t<EventDataType>::PassesSelection(const ParT& Par, std::size_t iEvent) {
// ***************************************************************************
