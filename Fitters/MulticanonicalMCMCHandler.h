...
public:
  ...
  /// relative to the new biased space the chain sees the same. Current assumes that your are sampling delta cp (ie circular on 2pi)
  /// @todo grab the step scale from the object directly and update based on the radtio to the umbrella width, removing assumption that its dcp
...
protected:
  ...
  /// @details briefly tested feature to mirror windows about their centres. Not tested but may be useful in the future. Currently disabled and not used.
  bool flipWindow;
